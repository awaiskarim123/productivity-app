...
<div class="mx-auto max-w-7xl space-y-4 sm:space-y-6">
	<div class="mb-6">
		<h1 class="text-2xl font-bold text-gray-900 dark:text-slate-100 sm:text-3xl">Productivity Tools</h1>
		<p class="mt-2 text-sm text-gray-600 dark:text-slate-400 sm:text-base">
			Manage your tasks, track your habits, and capture your thoughts
		</p>
	</div>
